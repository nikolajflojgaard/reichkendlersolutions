...
export const SITE: Site = {
  ...
  desc: "ReichkendlerSolutions opgraderer hjemmesider og bygger nye løsninger for danske virksomheder. Fast pris. Hurtig levering. Klar retning.",
  title: "ReichkendlerSolutions",
  ogImage: "avatar.jpg",
